...
namespace WaterColorFilter
{
  ...
  [Serializable]
  [PostProcess(typeof(WaterColorRenderer), PostProcessEvent.BeforeStack, "Hidden/WaterColorFilter")]
  public class WaterColorFilter : PostProcessEffectSettings
  {

    public TextureParameter wobbTex;
  ...
  public class WaterColorRenderer : PostProcessEffectRenderer<EdgeDetect>
  {
