...
namespace UnityEngine.Experimental.Rendering.LightweightPipeline
{
  ...
  public class LightweightPipelineAssetEditor : Editor
  {
    ...
    internal class Styles
    {
      ...
      public static GUIContent toonShadingLabel = new GUIContent("Toon Shading");
      ...
      public static GUIContent toonShadingRampTexture = new GUIContent("Toonshader Ramp",
"This texture is sampled by the the lambert and PBR lighting functions in order to quantize the surface illumination");
    ...
    SerializedProperty m_toonshadingRamp;
    ...
    void OnEnable()
    {
      ...
      m_toonshadingRamp = serializedObject.FindProperty("m_toonshadingRamp");
    }
    ...
    void DrawShadowSettings()
    {
      ...
      if (shadowsSettingsFoldout)
      {
        ...
        EditorGUILayout.LabelField(Styles.toonShadingLabel);
        EditorGUI.indentLevel++;
        if (m_toonshadingRamp.objectReferenceValue == null)
        {
          m_toonshadingRamp.objectReferenceValue = EditorGUIUtility.whiteTexture;
        }
        EditorGUILayout.PropertyField(m_toonshadingRamp, Styles.toonShadingRampTexture, false);
        EditorGUI.indentLevel--;
        EditorGUI.EndDisabledGroup();
        EditorGUI.indentLevel--;
      }
