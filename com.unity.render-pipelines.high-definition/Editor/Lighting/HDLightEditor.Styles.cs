...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    partial class HDLightEditor
    {
        sealed class Styles
        {
            ...
            public readonly GUIContent sunHaloPercent = new GUIContent("Sun Highlight Halo Percent", "Controls the size of the halo around the highlight of the sun disk.");
