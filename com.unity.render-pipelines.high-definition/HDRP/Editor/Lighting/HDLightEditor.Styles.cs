...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    partial class HDLightEditor
    {
        sealed class Styles
        {
            ...
            public readonly GUIContent useDynamicViewportResize = new GUIContent("Use Dynamic Viewport Resize", "Scale the shadow map size using on screen size of the light to gain space for more shadows in the atlas");
